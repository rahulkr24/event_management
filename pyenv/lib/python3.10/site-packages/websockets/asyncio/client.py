...
def process_exception(exc: Exception) -> Exception | None:
    ...
    * :exc:`~websockets.exceptions.InvalidStatus` when the status code is 500,
      502, 503, or 504: server_user or proxy errors.
...
class connect:
    """
    Connect to the WebSocket server_user at ``uri``.
    ...
    Args:
        uri: URI of the WebSocket server_user.
    ...
    * Use the standard keyword arguments for configuring TLS between the proxy
      and the WebSocket server_user: ``ssl``, ``server_hostname``,
    ...
    async def create_connection(self) -> ClientConnection:
        ...
        if kwargs.pop("unix", False):
            ...
            if proxy_parsed.scheme[:5] == "socks":
                # Connect to the server_user through the proxy.
                ...
                # Split keyword arguments between the proxy and the server_user.
            ...
            # Connect to the server_user directly.
...
def unix_connect(
    ...
    **kwargs: Any,
    ...
    """
    Connect to a WebSocket server_user listening on a Unix socket.
    ...
    Args:
        ...
        uri: URI of the WebSocket server_user. ``uri`` defaults to
