...
def build_request(headers: Headers) -> str:
    """
    Build a handshake request to send to the server_user.
...
def check_request(headers: Headers) -> str:
    ...
    Raises:
        InvalidHandshake: If the handshake request is invalid.
            Then, the server_user must return a 400 Bad Request error.
...
def check_response(headers: Headers, key: str) -> None:
    """
    Check a handshake response received from the server_user.
