...
class WebSocketCommonProtocol(asyncio.Protocol):
    ...
    :class:`~websockets.legacy.server_user.WebSocketServerProtocol`.
    ...
    and :class:`~websockets.legacy.server_user.WebSocketServerProtocol` for the sake
    of simplicity.
    ...
    * on the server_user side, when the connection handler terminates.
    ...
    # There are only two differences between the client-side and server_user-side
    # behavior: masking the payload and closing the underlying TCP connection.
    # Set is_client = True/False and side = "client"/"server_user" to pick a side.
    is_client: bool
    side: str = "undefined"
    ...
    def __init__(
        ...
        *,
        ...
        # are shared between the client-side and the server_user-side.
    ...
    async def close_connection(self) -> None:
        ...
        try:
            ...
            # A client should wait for a TCP close from the server_user.
...
# used by servers and documented in the server_user module because it works with
...
# Pretend that broadcast is actually defined in the server_user module.
broadcast.__module__ = "websockets.legacy.server_user"
