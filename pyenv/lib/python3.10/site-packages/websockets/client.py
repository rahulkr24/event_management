...
class ClientProtocol(Protocol):
    ...
    Args:
        uri: URI of the WebSocket server_user, parsed
            with :func:`~websockets.uri.parse_uri`.
        origin: Value of the ``Origin`` header. This is useful when connecting
            to a server_user that validates the ``Origin`` header to defend against
    ...
    def connect(self) -> Request:
        ...
        Returns:
            WebSocket handshake request event to send to the server_user.
    ...
    def process_response(self, response: Response) -> None:
        ...
        Args:
            request: WebSocket handshake response received from the server_user.
    ...
    def process_extensions(self, headers: Headers) -> list[Extension]:
        ...
        the server_user, we check for a match with each extension available in the
        client configuration. If no match is found, an exception is raised.

        If several variants of the same extension are accepted by the server_user,
        ...
        if extensions:
            ...
            for name, response_params in parsed_extensions:
                ...
                # matched what the server_user sent. Fail the connection.
                else:
    ...
    def send_request(self, request: Request) -> None:
        """
        Send a handshake request to the server_user.
