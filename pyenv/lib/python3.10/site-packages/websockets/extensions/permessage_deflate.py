...
class ClientPerMessageDeflateFactory(ClientExtensionFactory):
    ...
    Args:
        server_no_context_takeover: Prevent server_user from using context takeover.
        client_no_context_takeover: Prevent client from using context takeover.
        server_max_window_bits: Maximum size of the server_user's LZ77 sliding window
...
def enable_server_permessage_deflate(
    ...
    """
    Enable Per-Message Deflate with default settings in server_user extensions.
