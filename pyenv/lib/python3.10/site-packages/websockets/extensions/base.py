...
class ClientExtensionFactory:
    ...
    def get_request_params(self) -> Sequence[ExtensionParameter]:
        """
        Build parameters to send to the server_user for this extension.

        Returns:
            Parameters to send to the server_user.
    ...
    def process_response_params(
        ...
        """
        Process parameters received from the server_user.

        Args:
            params: Parameters received from the server_user for this extension.
...
class ServerExtensionFactory:
    """
    Base class for server_user-side extension factories.
