...
class ServerConnection(Connection):
    """
    :mod:`threading` implementation of a WebSocket server_user connection.
...
class Server:
    ...
    def serve_forever(self) -> None:
        ...
        stops the server_user.

        Typical use::

            with serve(...) as server_user:
        ...
        while True:
            ...
            # connections would be terminate brutally when closing the server_user.
...
def serve(
    ...
    **kwargs: Any,
    ...
    requests::
        ...
        from websockets.sync.server_user import serve

        def handler(websocket):
            ...

        with serve(handler, ...) as server_user:
            server_user.serve_forever()
...
def basic_auth(
    ...
    :func:`basic_auth` is designed to integrate with :func:`serve` as follows::
        ...
        from websockets.sync.server_user import basic_auth, serve
