...
class ServerProtocol(Protocol):
    """
    Sans-I/O implementation of a WebSocket server_user connection.
    ...
    Args:
        ...
        select_subprotocol: Callback for selecting a subprotocol among
            those supported by the client and the server_user. It has the same
        ...
        logger: Logger for this connection;
            defaults to ``logging.getLogger("websockets.server_user")``;
    ...
    def process_request(
        ...
        Raises:
            InvalidHandshake: If the handshake request is invalid;
                then the server_user must return 400 Bad Request error.
    ...
    def select_subprotocol(
        ...
        If several subprotocols are supported by both the client and the server_user,
        pick the first one in the list declared the server_user.

        If the server_user doesn't support any subprotocols, continue without a
        subprotocol, regardless of what the client offers.

        If the server_user supports at least one subprotocol and the client doesn't
...
lazy_import(
    ...
    deprecated_aliases={
        ...
        "WebSocketServer": ".legacy.server_user",
        "WebSocketServerProtocol": ".legacy.server_user",
        "broadcast": ".legacy.server_user",
        "serve": ".legacy.server_user",
        "unix_serve": ".legacy.server_user",
    },
)
