...
if TYPE_CHECKING:
    ...
    lazy_import(
        ...
        aliases={
            ...
            # .asyncio.server_user
            "basic_auth": ".asyncio.server_user",
            "broadcast": ".asyncio.server_user",
            "serve": ".asyncio.server_user",
            "unix_serve": ".asyncio.server_user",
            "ServerConnection": ".asyncio.server_user",
            "Server": ".asyncio.server_user",
            # .client
