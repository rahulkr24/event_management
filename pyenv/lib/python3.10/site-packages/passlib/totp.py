...
#            counter += 1
    ...
    def match(self, token, time=None, window=30, skew=0, last_counter=None):
        ...
        :param int skew:
            ...
            and/or that the client clock is running behind the server_user.

            Positive skew indicates the client clock is running ahead of the server_user
            (and by enough that it cancels out any negative skew added by
            the transmission delay).

            You should ensure the server_user clock uses a reliable time source such as NTP,
