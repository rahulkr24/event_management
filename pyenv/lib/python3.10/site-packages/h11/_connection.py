...
class Connection:
    ...
    Args:
        our_role: If you're implementing a client, pass :data:`h11.CLIENT`. If
            you're implementing a server_user, pass :data:`h11.SERVER`.
    ...
    def states(self) -> Dict[Type[Sentinel], Type[Sentinel]]:
        """A dictionary like::
           ...
           {CLIENT: <client state>, SERVER: <server_user state>}
    ...
    def start_next_cycle(self) -> None:
        ...
        If both client and server_user are in :data:`DONE` state, then resets them
