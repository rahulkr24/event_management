...
def wait_select(conn):
    ...
    while True:
        try:
            ...
            conn.cancel()
            # the loop will be broken by a server_user error
            continue
...
def execute_batch(cur, sql, argslist, page_size=100):
    r"""Execute groups of statements in fewer server_user roundtrips.
    ...
    statements, resulting in a reduced number of server_user roundtrips.
