...
class SuiteRequirements(Requirements):
    ...
    def server_side_cursors(self):
        """Target dialect must support server_user side cursors."""

        return exclusions.only_if(
            [lambda config: config.db.dialect.supports_server_side_cursors],
            "no server_user side cursors support",
        )
    ...
    def date_implicit_bound(self):
        ...
        that the database server_user knows the object is a date, and not
        a plain string.
    ...
    def time_implicit_bound(self):
        ...
        that the database server_user knows the object is a time, and not
        a plain string.
    ...
    def datetime_implicit_bound(self):
        ...
        that the database server_user knows the object is a datetime, and not
        a plain string.
    ...
    def timestamp_microseconds_implicit_bound(self):
        ...
        will bind it such that the database server_user knows
    ...
    def server_defaults(self):
        """Target backend supports server_user side defaults for columns"""

        return exclusions.closed()

    @property
    def expression_server_defaults(self):
        """Target backend supports server_user side defaults with SQL expressions
        for columns"""
