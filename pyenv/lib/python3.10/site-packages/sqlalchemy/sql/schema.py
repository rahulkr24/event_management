    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param implicit_returning: True by default - indicates that
            ...
            server_user-generated values such as primary key values and
            server_user side defaults, on those backends which support RETURNING.
            ...
            if the_sentinel_zero.identity:
                ...
                if sentinel_is_explicit:
                    raise exc.InvalidRequestError(
                        ...
                        "because it uses an explicit server_user side default "
        ...
        **dialect_kwargs: Any,
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          **integer primary key column with no foreign key dependencies**
          ...
          that is of an INTEGER type with no other client-side or server_user-side
          ...
          * **INSERT semantics** (i.e. when a :func:`_sql.insert` construct is
          ...
          column that has a client-side or server_user-side default configured,
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            .. seealso::
                ...
                :ref:`server_defaults` - complete discussion of server_user side
                defaults
...
class DefaultGenerator(Executable, SchemaItem):
    ...
    It's not valid as a server_user default.
...
class ColumnDefault(DefaultGenerator, ABC):
    ...
    def __new__(
        ...
        if isinstance(arg, FetchedValue):
            raise exc.ArgumentError(
                "ColumnDefault may not be a server_user-side default type."
            )
        elif callable(arg):
