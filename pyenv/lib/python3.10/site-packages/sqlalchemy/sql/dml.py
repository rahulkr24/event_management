...
class UpdateBase(
    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        of fetching server_user-side expressions and defaults, for supporting
        backends only.
        ...
        .. deepalchemy::
            ...
            and server_user default values, in particular to provide the underyling
        ...
        data; if it was generated using server_user-side defaults and / or SQL
        ...
        inserted primary key values as well as newly inserted server_user generated
    ...
    def returning(
        ...
        **__kw: Any,
        ...
        .. seealso::
          ...
          towards efficient fetching of server_user-side defaults and triggers
    ...
    def values(
        ...
        **kwargs: Any,
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         server_user will render the less common SQL syntax of "multiple values" -
...
class Insert(ValuesBase):
    ...
    def from_select(
        ...
        :param select: a :func:`_expression.select` construct,
         ...
         correspond.
        :param include_defaults: if True, non-server_user default values and
