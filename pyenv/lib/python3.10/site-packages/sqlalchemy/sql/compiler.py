...
class _InsertManyValues(NamedTuple):
    ...
    """if True, we have exactly one sentinel column and it uses a server_user side
...
class SQLCompiler(Compiled):
    ...
    receive server_user-updated values"""
    ...
    def _get_sentinel_column_for_table(
        ...
        if sentinel_characteristics.is_explicit:
            ...
            raise exc.InvalidRequestError(
                ...
                "server_user-generated value in "
        ...
        if returning_cols:
            ...
            if add_sentinel_cols is not None:
                ...
                if named_sentinel_params is None:
                    ...
                    # an autoincrement, an IDENTITY, or a server_user-side SQL
                    ...
                    # that guarantees the server_user side function lines up with
        ...
        if insert_stmt.select is not None:
            ...
            if use_insertmanyvalues:
                if (
                    ...
                    # if we have a sentinel column that is server_user generated,
