        ...
        if col_key in parameters and col_key not in check_columns:
            ...
            if c.primary_key and need_pks:
                ...
                if implicit_returning:
                    ...
                    # we can inline server_user-side functions in this case.
                    ...
                    # if we have to invoke a server_user-side function, we need
    ...
    if coercions._is_literal(value):
        ...
        if compile_state.isupdate:
            ...
            if c.primary_key:
                ...
                # inserted by primary key to get back the server_user generated
...
def _warn_pk_with_no_anticipated_value(c):
    msg = (
        ...
        "but has no Python-side or server_user-side default generator indicated, "
