...
class MSDialect_pymssql(MSDialect):
    ...
    def is_disconnect(self, e, connection, cursor):
        for msg in (
            ...
            "Error 10054",
            "Not connected to any MS SQL server_user",
            "Connection is closed",
            "message 20006",  # Write to the server_user failed
            "message 20017",  # Unexpected EOF from the server_user
            "message 20047",  # DBPROCESS is dead or not enabled
            "The server_user failed to resume the transaction",
        ):
            if msg in str(e):
                return True
        else:
