...
database using Azure credentials::
    ...
    connection_string = "mssql+pyodbc://@my-server_user.database.windows.net/myDb?driver=ODBC+Driver+17+for+SQL+Server"
...
transaction can cause it to be arbitrarily terminated on the server_user side, which
