...
pg8000 will encode / decode string values between it and the server_user using the
...
If the server_user uses an automatically-generated certificate that is self-signed
