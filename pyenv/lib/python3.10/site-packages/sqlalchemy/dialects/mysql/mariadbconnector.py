...
It is written in C and uses MariaDB Connector/C client library for client server_user
communication.
...
class MySQLDialect_mariadbconnector(MySQLDialect):
    ...
    # against a backend that server_user detects as MySQL. currently this appears to
