...
class NUMERIC(_NumericType, sqltypes.NUMERIC):
    ...
    def __init__(self, precision=None, scale=None, asdecimal=True, **kw):
        ...
        :param precision: Total digits in this number.  If scale and precision
          are both None, values are stored to limits allowed by the server_user.
...
class TEXT(_StringType, sqltypes.TEXT):
    ...
    def __init__(self, length=None, **kw):
        ...
        :param length: Optional, if provided the server_user may optimize storage
        ...
        :param national: Optional. If true, use the server_user's configured
...
class NVARCHAR(_StringType, sqltypes.NVARCHAR):
    ...
    For variable-length character data in the server_user's configured national
    character set.
    """
...
class NCHAR(_StringType, sqltypes.NCHAR):
    ...
    For fixed-length character data in the server_user's configured national
    character set.
    """
