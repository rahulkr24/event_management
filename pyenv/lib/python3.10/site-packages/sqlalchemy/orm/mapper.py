...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          value of server_user-generated default values after an INSERT or UPDATE,
          rather than leaving them as expired to be fetched on next access.
          This can be used for event schemes where the server_user-generated values
          ...
          string value ``"auto"``, which indicates that server_user defaults for
          ...
          ``RETURNING`` or "insertmanyreturning" is not available, server_user
        ...
        :param version_id_generator: Define how new version ids should
          ...
          Alternatively, server_user-side versioning functions such as triggers,
