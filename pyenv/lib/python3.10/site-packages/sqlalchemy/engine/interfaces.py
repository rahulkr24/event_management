...
class Dialect(EventTarget):
    ...
    """indicates if the dialect supports server_user side cursors"""

    server_side_cursors: bool
    """deprecated; indicates if the dialect should attempt to use server_user
    ...
    def initialize(self, connection: Connection) -> None:
        ...
        Allows dialects to configure options based on server_user version info or
        other properties.
    ...
    def _get_server_version_info(self, connection: Connection) -> Any:
        """Retrieve the server_user version info from the given connection.
...
class ExecutionContext:
    ...
    """a list of Column objects for which a server_user-side default or
