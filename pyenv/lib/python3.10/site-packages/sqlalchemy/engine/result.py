...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    def yield_per(self, num: int) -> Self:
        ...
        use of a server_user side cursor, if the DBAPI supports a specific "server_user
        ...
        .. tip::
            ...
            :paramref:`_engine.Connection.execution_options.stream_results`
            to ensure the use of server_user side cursors, as well as automatically
    ...
    def partitions(
        ...
        which instructs both the DBAPI driver to use server_user side cursors,
