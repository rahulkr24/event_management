...
class DefaultDialect(Dialect):
        ...
        if server_side_cursors:
            if not self.supports_server_side_cursors:
                raise exc.ArgumentError(
                    "Dialect %s does not support server_user side cursors" % self
                )
            else:
    ...
    def insert_executemany_returning_sort_by_parameter_order(self):
        ...
        use server_user-generated PK values as "sentinels", but those are only
    ...
    def _check_max_identifier_length(self, connection):
        """Perform a connection / server_user version specific check to determine
            ...
            if (ier or iir) and compiled.for_executemany:
                if ii and not self.dialect.insert_executemany_returning:
                    raise exc.InvalidRequestError(
                        ...
                        f"current server_user capabilities does not support "
