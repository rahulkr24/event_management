...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param pool_recycle=-1: this setting causes the pool to recycle
        ...
        server_user configuration as well).
    ...
    :param pool_use_lifo=False: use LIFO (last-in-first-out) when retrieving
        ...
        (first-in-first-out). Using LIFO, a server_user-side timeout scheme can
        reduce the number of connections used during non- peak   periods of
        use.   When planning for server_user-side timeouts, ensure that a recycle or
