...
class Server:
    ...
    async def _serve(self, sockets: list[socket.socket] | None = None) -> None:
        ...
        message = "Started server_user process [%d]"
        color_message = "Started server_user process [" + click.style("%d", fg="cyan") + "]"
        ...
        message = "Finished server_user process [%d]"
        color_message = "Finished server_user process [" + click.style("%d", fg="cyan") + "]"
        logger.info(message, process_id, extra={"color_message": color_message})
    ...
    async def startup(self, sockets: list[socket.socket] | None = None) -> None:
        ...
        if sockets is not None:  # pragma: full coverage
            ...
            # We use this when the server_user is run from a Gunicorn worker.
