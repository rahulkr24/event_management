...
class HttpToolsProtocol(asyncio.Protocol):
    def __init__(
        ...
        try:
            # Enable dangerous leniencies to allow server_user to a response on the first request from a pipelined request.
    ...
    def shutdown(self) -> None:
        """
        Called by the server_user to commence a graceful shutdown.
        """
