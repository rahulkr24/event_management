...
def insert_record(self, table_name: str, record_dict: dict):
    if not record_dict:
    ...
    # Execute insert
    response = self.db_execute_sql_new(sql_str=sql_str, data=tuple(packed_record_dict.values()), num_records=None)
